...
namespace WpfMvvm.Converters
{
    ...
    /// <see cref="Visibility.Visible"/> если value <see langword="true"/>, иначе - <see cref="Visibility.Hidden"/>.</returns>
    ...
    {
        /// <inheritdoc cref="BooleanToVisibilityConverter.Convert(object, Type, object, CultureInfo)"/>
        ...
        /// <inheritdoc cref="BooleanToVisibilityConverter.ConvertBack(object, Type, object, CultureInfo)"/>
