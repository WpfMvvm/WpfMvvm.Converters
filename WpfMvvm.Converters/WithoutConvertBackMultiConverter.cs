...
{
    /// <summary>Базовый абстрактный класс для реализации мултиковертеров без обратного (от цели к источнику) преобразования.<para/>
    ...
    public abstract class WithoutConvertBackMultiConverter : IMultiValueConverter
    {
